...
namespace ConsoleOptions.Test
{
    ...
    public class FlaglessOptionTest
    {
            ...
            {
                bool result = false;
                Option o = new Option(x=>result=x, "value","");
                o.Invoke("","True");
            ...
            {
                short result = 0;
                Option o = new Option((short x)=>result=x, "value","");
                o.Invoke("","1");
            ...
            {
                double result = 0;
                Option o = new Option((double x)=>result=x, "value","");
                o.Invoke("","1.1");
            ...
            {
                byte result = 0;
                Option o = new Option((byte x)=>result=x, "value","");
                o.Invoke("","240");
            ...
            {
                Option o = new Option((int x)=>Console.Write(x), "value","");
